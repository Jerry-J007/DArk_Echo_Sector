...
const enemy_manager_singleton_controller_factory = {
    ...
    // NEW: Sniper - High damage, very fast bullets, long cooldown
    ...
    // NEW: Dasher - High speed, closes distance rapidly with a dash mechanic
    ...
    // NEW: Explosive - Chases player and flashes before blowing up
    ...
    // NEW: Cloaked - Invisible until you get close
    ...
    spawnWave: function(state_object) {
        ...
        if(level===1){
        // Spawn them across your custom map!
        ...
        //       state_object.enemies.push(this.createCloaked(1020, 750));
            ...
            // LEVEL 3: THE OMEGA CORE (BOSS FIGHT)
            state_object.enemies.push(this.createBoss(1000, 600));
            
            // 4 Guard Turrets in the corners of the boss room
